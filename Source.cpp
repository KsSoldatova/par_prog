...
{
    int COUNT_OP = 10;
    int** matrix = readMatrix("C:\\Users\\kssol\\source\\repos\\pp_lab1\\pp_lab1\\matrix_500.csv");
    int rows = 500;
    ...
    for (int i = 0; i < COUNT_OP; i++) {
        int time_res = fixTime(matrix, rows, "C:\\Users\\kssol\\source\\repos\\pp_lab1\\pp_lab1\\res_500.csv");
        matrix_time[0][i] = time_res;
    }
    std::cout << "The result is written to a file" << std::endl;
    clearMemory(matrix, rows);

    matrix = readMatrix("C:\\Users\\kssol\\source\\repos\\pp_lab1\\pp_lab1\\matrix_1000.csv");
    rows = 1000;
    std::cout << std::endl << "Matrix multiplication with size" << " " << rows << "*" << rows << std::endl;
    for (int i = 0; i < COUNT_OP; i++) {
        int time_res = fixTime(matrix, rows, "C:\\Users\\kssol\\source\\repos\\pp_lab1\\pp_lab1\\res_1000.csv");
        matrix_time[1][i] = time_res;
    }
    std::cout << "The result is written to a file" << std::endl;
    clearMemory(matrix, rows);

    matrix = readMatrix("C:\\Users\\kssol\\source\\repos\\pp_lab1\\pp_lab1\\matrix_1500.csv");
    rows = 1500;
    std::cout << std::endl << "Matrix multiplication with size" << " " << rows << "*" << rows << std::endl;
    for (int i = 0; i < COUNT_OP; i++) {
        int time_res = fixTime(matrix, rows, "C:\\Users\\kssol\\source\\repos\\pp_lab1\\pp_lab1\\res_1500.csv");
        matrix_time[2][i] = time_res;
    }
    std::cout << "The result is written to a file" << std::endl;
    std::cout << "The time result is written to a file" << std::endl;
    writeMatrixTime(matrix_time, 3, COUNT_OP, "C:\\Users\\kssol\\source\\repos\\pp_lab1\\pp_lab1\\matrix_time.csv");
    clearMemory(matrix, rows);
